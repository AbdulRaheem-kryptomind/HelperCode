...
import coinIcons from "../../constant/constants";
import {
  Table,
  Tag,
  Drawer,
...
import hogiConfig from "../../hogi.config";
import moment from "moment";
import Highlighter from "react-highlight-words";

const API_URL = hogiConfig.API_URL;
...
const CoinManagement = () => {
  ...
  const uploadProps = {
    ...
    listType: "picture",
    multiple: true,
    action: `${API_URL}/admin/coin/upload`,
    beforeUpload: (file) => {
  ...
  const columns = [
    {
      ...
      render: (text, record) => {
        return (
          // <img
          //   src={`${API_URL}/admin/coin/${record.symbol}`}
          //   alt={record.coin}
          // />
          <img
